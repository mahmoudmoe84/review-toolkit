...
claude-opus-5 (2026-07-23 → 2026-07-31), claude-fable-5 (the 2026-08-01 sweep:
9 PASS, Plant 6 FAIL by the caller, Plant 1 short). Other ecosystems and other
models are not weaker evidence — they are **no** evidence, which is what the
map's model-change row now enforces.
